...
// given array where all numbers appear twice except two different ones
// find these numbers
void find_nonrepeating_numbers(int *a, int n) {
...
int main() {
    ...
    int a[] = {10,10,15,15,28,28,1111,1111,1233,1233,892,892,
        122,454};

    int n = sizeof(a)/sizeof(int);
    find_nonrepeating_numbers(a, n);
